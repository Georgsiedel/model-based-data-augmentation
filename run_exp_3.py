...
if __name__ == '__main__':
    ...
    for experiment in [480,491,41,71,477,483,51,495,497,504,505,520,521,525,91,61,534,537,540,535]:
        ...
        for run in run_iter:
            ...
            resume = True if experiment in [480,491] and run in [0] else False
