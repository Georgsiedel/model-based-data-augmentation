...
if __name__ == '__main__':
    ...
    for experiment in [405] + list(range(425,432))+ [41,343,344,345,359,360,361,323,322,321]:
        ...
        if experiment in [386,388]:
            runs = 3
            run_iter =[1,2]
        if experiment in [405]:
            runs = 3
            run_iter =[2]

        for run in run_iter:

            resume = True if experiment in [405] and run in [2] else False
