...
if __name__ == '__main__':
    ...
    for experiment in [511,369,389,390,391,392,393,396,397,398,399,400,401,402,403]:
        ...
        if experiment in [369,389,390,391,392,393,396,397,398,399,400,401,402,403]:
            runs = 3
            run_iter =[1,2]        

        for run in run_iter:
            
            resume = True if experiment in [369] and run in [1] else False
