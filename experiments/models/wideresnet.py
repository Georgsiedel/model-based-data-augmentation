...
class WideResNet(ct_model.CtModel):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super(WideResNet, self).__init__(
            dataset=dataset, normalized=normalized, num_classes=num_classes, **kwargs
        )
        self.in_planes = 16
    ...
    def forward(
        ...
        mixup_p=0.0,
        manifold=False,
        manifold_noise_factor=1,
        cutmix_alpha=0.0,
        cutmix_p=0.0,
        noise_minibatchsize=1,
