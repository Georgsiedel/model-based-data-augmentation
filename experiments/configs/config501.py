...
train_aug_strat_orig = 'AugMix' #TrivialAugmentWide, RandAugment, AutoAugment, AugMix
train_aug_strat_gen = 'AugMix' #TrivialAugmentWide, RandAugment, AutoAugment, AugMix
