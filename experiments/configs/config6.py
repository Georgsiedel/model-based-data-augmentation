...
# CIFAR100 with Internal AdaIN, without gen data, without TA
...
robust_lossparams = {
    "num_splits": 3,
    "alpha": 12,
}  # jsd if 3 splits, KL divergence if 2 splits
mixup = {
    "alpha": 0.2,
    "p": 0.0,
}  # default alpha 0.2 #If both mixup and cutmix are >0, mixup or cutmix are selected by 0.5 chance
cutmix = {
    "alpha": 1.0,
    "p": 0.0,
...
adv_distance_params = {
    "setsize": 500,
    "iters_pgd": 500,
    "eps_iter": [0.0003, 0.005, 0.2],
    "iters_second_attack": 40,
    "norm": ["inf", 2, 1],
    "clever": True,
    "clever_batches": [5, 10, 50, 500],
    "clever_samples": [5, 20, 100, 1024],
}
