...
def get_transforms_map(strat_name, re, dataset, factor):
    ...
    transform_map = { #this contain a tuple each, defining the CPU transforms later applied in the dataloader and if needed GPU transforms later applied on the batch
        ...
        "StyleTransferalpha10": (DatasetStyleTransforms(stylized_ratio=0.5, batch_size=50, transform_style=stylization(dataset, factor, probability=1.0, alpha_min=1.0, alpha_max=1.0)), 
                            re,
                            re), 
        "StyleTransfer100": (DatasetStyleTransforms(stylized_ratio=1.0, batch_size=50, transform_style=stylization(dataset, factor, probability=1.0, alpha_min=0.5, alpha_max=1.0)), 
                            re,
                            re),
        "StyleTransfer90": (DatasetStyleTransforms(stylized_ratio=0.9, batch_size=50, transform_style=stylization(dataset, factor, probability=1.0, alpha_min=0.5, alpha_max=1.0)), 
                            re,
                            re),
        "StyleTransfer80": (DatasetStyleTransforms(stylized_ratio=0.8, batch_size=50, transform_style=stylization(dataset, factor, probability=1.0, alpha_min=0.5, alpha_max=1.0)), 
                            re,
                            re),
        "StyleTransfer70": (DatasetStyleTransforms(stylized_ratio=0.7, batch_size=50, transform_style=stylization(dataset, factor, probability=1.0, alpha_min=0.5, alpha_max=1.0)), 
                            re,
                            re),
        "StyleTransfer60": (DatasetStyleTransforms(stylized_ratio=0.6, batch_size=50, transform_style=stylization(dataset, factor, probability=1.0, alpha_min=0.5, alpha_max=1.0)), 
                            re,
                            re),     
        "StyleTransfer50": (DatasetStyleTransforms(stylized_ratio=0.5, batch_size=50, transform_style=stylization(dataset, factor, probability=1.0, alpha_min=0.5, alpha_max=1.0)), 
                            re,
                            re),    
        ...
        "StyleTransfer50alpha08-10": (DatasetStyleTransforms(stylized_ratio=0.5, batch_size=50, transform_style=stylization(dataset, factor, probability=1.0, alpha_min=0.8, alpha_max=1.0)), 
                            re,
                            re),
        "StyleTransfer40": (DatasetStyleTransforms(stylized_ratio=0.4, batch_size=50, transform_style=stylization(dataset, factor, probability=1.0, alpha_min=0.5, alpha_max=1.0)), 
                            re,
                            re),     
        "StyleTransfer30": (DatasetStyleTransforms(stylized_ratio=0.3, batch_size=50, transform_style=stylization(dataset, factor, probability=1.0, alpha_min=0.5, alpha_max=1.0)), 
                            re,
                            re),     
        "StyleTransfer20": (DatasetStyleTransforms(stylized_ratio=0.2, batch_size=50, transform_style=stylization(dataset, factor, probability=1.0, alpha_min=0.5, alpha_max=1.0)), 
                            re,
                            re),     
        "StyleTransfer10": (DatasetStyleTransforms(stylized_ratio=0.1, batch_size=50, transform_style=stylization(dataset, factor, probability=1.0, alpha_min=0.5, alpha_max=1.0)), 
                            re,
                            re),                                                               
