...
def get_transforms_map(strat_name, re, dataset, factor):
    ...
    transform_map = { #this contain a tuple each, defining the CPU transforms later applied in the dataloader and if needed GPU transforms later applied on the batch
        ...
        "StyleTransfer10alpha05-08": (DatasetStyleTransforms(stylized_ratio=0.1, batch_size=50, transform_style=stylization(dataset, factor, probability=1.0, alpha_min=0.5, alpha_max=0.8)), 
                            re,
                            re), 
        "StyleTransfer100alpha06": (DatasetStyleTransforms(stylized_ratio=1.0, batch_size=50, transform_style=stylization(dataset, factor, probability=1.0, alpha_min=0.6, alpha_max=0.6)), 
                            re,
                            re),
        "StyleTransfer90alpha06": (DatasetStyleTransforms(stylized_ratio=0.9, batch_size=50, transform_style=stylization(dataset, factor, probability=1.0, alpha_min=0.6, alpha_max=0.6)), 
                            re,
                            re),
        "StyleTransfer80alpha06": (DatasetStyleTransforms(stylized_ratio=0.8, batch_size=50, transform_style=stylization(dataset, factor, probability=1.0, alpha_min=0.6, alpha_max=0.6)), 
                            re,
                            re),
        "StyleTransfer70alpha06": (DatasetStyleTransforms(stylized_ratio=0.7, batch_size=50, transform_style=stylization(dataset, factor, probability=1.0, alpha_min=0.6, alpha_max=0.6)),  
                            re,
                            re),
        "StyleTransfer60alpha06": (DatasetStyleTransforms(stylized_ratio=0.6, batch_size=50, transform_style=stylization(dataset, factor, probability=1.0, alpha_min=0.6, alpha_max=0.6)),  
                            re,
                            re),     
        "StyleTransfer40alpha06": (DatasetStyleTransforms(stylized_ratio=0.4, batch_size=50, transform_style=stylization(dataset, factor, probability=1.0, alpha_min=0.6, alpha_max=0.6)),  
                            re,
                            re),     
        "StyleTransfer30alpha06": (DatasetStyleTransforms(stylized_ratio=0.3, batch_size=50, transform_style=stylization(dataset, factor, probability=1.0, alpha_min=0.6, alpha_max=0.6)), 
                            re,
                            re),     
        "StyleTransfer20alpha06": (DatasetStyleTransforms(stylized_ratio=0.2, batch_size=50, transform_style=stylization(dataset, factor, probability=1.0, alpha_min=0.6, alpha_max=0.6)),  
                            re,
                            re),     
        "StyleTransfer10alpha06": (DatasetStyleTransforms(stylized_ratio=0.1, batch_size=50, transform_style=stylization(dataset, factor, probability=1.0, alpha_min=0.6, alpha_max=0.6)), 
                            re,
                            re),                                                               
