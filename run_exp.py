...
if __name__ == '__main__':
    ...
    for experiment in [295,196,318,321,322,323,324,325]:
        ...
        if experiment in [295,318,321,322,323,324,325]:
            runs = 3
            run_iter =[1,2]
        if experiment in [318]:
            run_iter =[2]

        for run in run_iter:
            if experiment in [318] and run==2:
                resume = True
            elif experiment in [196,295] and run in [0,1]:
                resume = True
            else:
                resume = False
