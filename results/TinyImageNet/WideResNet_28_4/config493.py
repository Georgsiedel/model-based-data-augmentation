...
resize = False
train_aug_strat_orig = 'TAandStyle30alpha10' #TrivialAugmentWide, RandAugment, AutoAugment, AugMix
train_aug_strat_gen = 'TAandStyle40alpha01-10' #TrivialAugmentWide, RandAugment, AutoAugment, AugMix
