...
if __name__ == '__main__':
    ...
    for experiment in [423,424,438,439,440,441,442] + list(range(346,353)) + [12,283,285,287]:
        ...
        if experiment in [423]:
            runs = 3
            run_iter =[]

        for run in run_iter:

            resume = True if experiment in [424] and run in [0] else False
