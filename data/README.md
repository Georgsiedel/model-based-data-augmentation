...
Stylemix in our implementation requires encoded image features from the painter-by-numbers dataset to be put into the data repository, named "style_feats_adain_1000.npy", as can be downloaded from here: https://zenodo.org/records/16279015
